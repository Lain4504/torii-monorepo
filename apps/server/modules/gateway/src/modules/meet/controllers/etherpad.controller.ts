...
export class EtherpadController {
    ...
    async createSession(@Body() body: any, @Res() res: Response) {
        try {
            ...
            return res.status(HttpStatus.OK).json({ status: false, msg: error.message });
        }
    }
    ...
    async cleanSession(@Body() body: any, @Res() res: Response) {
        try {
            ...
            return res.status(HttpStatus.OK).json({ status: true, msg: 'clean initiated' });
        } catch (error) {
    ...
    async changeStatus(@Body() body: any, @Res() res: Response) {
        try {
            ...
            res.status(HttpStatus.OK);
            sendProtoJsonResponse(res, CommonResponseSchema, { status: true, msg: 'status changed' });
        } catch (error) {
