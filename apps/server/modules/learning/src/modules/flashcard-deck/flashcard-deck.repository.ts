...
export class FlashcardDeckRepository implements IFlashcardDeckRepository {
    ...
    async findById(id: string, include?: Prisma.FlashcardDeckInclude): Promise<FlashcardDeck | null> {
    ...
    async update(id: string, data: Prisma.FlashcardDeckUpdateInput): Promise<FlashcardDeck> {
