...
export class ExamRepository implements IExamRepository {
     ...
     * Find quiz by ID
     */
    async findById(quizId: string, include?: Prisma.QuizInclude): Promise<Quiz | null> {
     ...
     */
    async findAttemptById(attemptId: string, include?: Prisma.QuizAttemptInclude): Promise<QuizAttempt | null> {
     ...
     * Create quiz attempt
     */
    async createAttempt(data: Prisma.QuizAttemptCreateInput): Promise<QuizAttempt> {
     ...
     */
    async updateAttempt(attemptId: string, data: Prisma.QuizAttemptUpdateInput): Promise<QuizAttempt> {
     ...
     */
    async createAttemptDetails(data: Prisma.QuizAttemptDetailCreateManyInput[]): Promise<{ count: number }> {
