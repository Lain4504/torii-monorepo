...
export class CourseInstructorHandler {
    ...
    async updatePrimaryInstructor(@Payload() data: CourseInstructorUpdateDTO & { id: string, userId: string }) {
    ...
    async unassignLecturer(@Payload() data: { id: string, userId: string }) {
