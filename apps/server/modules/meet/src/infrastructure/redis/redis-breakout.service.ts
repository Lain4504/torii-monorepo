...
export class RedisBreakoutService {
    ...
    async insertOrUpdateBreakoutRoom(parentRoomId: string, bkRoomId: string, val: Buffer | string): Promise<void> {
        ...
        try {
            ...
            this.logger.error(`InsertOrUpdateBreakoutRoom failed for parentRoomId ${parentRoomId}: ${error.message}`);
            throw error;
        }
    }
    ...
    async deleteBreakoutRoom(parentRoomId: string, bkRoomId: string): Promise<void> {
        ...
        try {
            ...
            this.logger.error(`DeleteBreakoutRoom failed for parentRoomId ${parentRoomId}, bkRoomId ${bkRoomId}: ${error.message}`);
            throw error;
        }
    }
    ...
    async getBreakoutRoom(parentRoomId: string, bkRoomId: string): Promise<string | null> {
        ...
        try {
            ...
            this.logger.error(`GetBreakoutRoom failed for parentRoomId ${parentRoomId}, bkRoomId ${bkRoomId}: ${error.message}`);
            throw error;
        }
    }
    ...
    async countBreakoutRooms(parentRoomId: string): Promise<number> {
        ...
        try {
            ...
            this.logger.error(`CountBreakoutRooms failed for parentRoomId ${parentRoomId}: ${error.message}`);
            throw error;
        }
    }
    ...
    async getAllBreakoutRoomsByParentRoomId(parentRoomId: string): Promise<Record<string, string>> {
        ...
        try {
            ...
            this.logger.error(`GetAllBreakoutRoomsByParentRoomId failed for parentRoomId ${parentRoomId}: ${error.message}`);
            throw error;
        }
    }
    ...
    async deleteAllBreakoutRoomsByParentRoomId(parentRoomId: string): Promise<void> {
        ...
        try {
            ...
            this.logger.error(`DeleteAllBreakoutRoomsByParentRoomId failed for parentRoomId ${parentRoomId}: ${error.message}`);
            throw error;
        }
    }
    ...
    async getBreakoutRoomIdsByParentRoomId(parentRoomId: string): Promise<string[]> {
        ...
        try {
            ...
            this.logger.error(`GetBreakoutRoomIdsByParentRoomId failed for parentRoomId ${parentRoomId}: ${error.message}`);
            throw error;
        }
    }
}
