...
export class ExamService {
     ...
     */
    async findAllWithStatus(query: ExamQueryDTO, userId?: string): Promise<PaginatedResponse<ExamWithStatusResponseDTO>> {
        try {
            const {
                page = 1,
                limit = 10,
     ...
     */
    async findAll(query: ExamQueryDTO): Promise<PaginatedResponse<ExamResponseDTO>> {
        try {
            const {
                page = 1,
                limit = 10,
     ...
     */
    async getUserSessions(userId: string, query: ExamSessionQueryDTO): Promise<PaginatedResponse<ExamSessionWithExamResponseDTO>> {
        try {
            const {
                page = 1,
                limit = 10,
