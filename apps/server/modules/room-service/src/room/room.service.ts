...
export class RoomService {
    ...
    async getPollStats(data: { roomId: string; pollId: string }) {
        try {
            ...
            // Design Decision: We return raw responses so client can calculate detailed stats.
            // Future optimization: Cache aggregated stats in Redis.
    ...
    async createIngress(data: CreateIngressDto) {
        try {
            ...
            // This is a nice-to-have optimization, not critical for core function.
