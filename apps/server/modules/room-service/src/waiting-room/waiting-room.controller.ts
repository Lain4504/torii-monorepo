/**
 * Waiting Room Controller (Room Service - Microservice)
 * 
...
export class WaitingRoomController {
    ...
    async handleApproveUsers(@Payload() req: ApproveWaitingUsersReq): Promise<{ status: boolean; msg: string }> {
    ...
    async handleUpdateWaitingRoomMessage(@Payload() req: UpdateWaitingRoomMessageReq): Promise<{ status: boolean; msg: string }> {
