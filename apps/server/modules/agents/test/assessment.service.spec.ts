...
describe('AssessmentService', () => {
    ...
    describe('generateJlptTest', () => {
        it('should call callTool with assessment_generate_test and default questionCount 10', async () => {
            ...
            const result = await service.generateJlptTest(mockRequester as any, 'N4', 'vocabulary');

            expect(fastMcpService.callTool).toHaveBeenCalledWith('assessment_generate_test', {
                userId: 'user-001',
                level: 'N4',
                section: 'vocabulary',
                questionCount: 10,
    ...
    describe('evaluateTest', () => {
        ...
        it('should call callTool with assessment_evaluate_test', async () => {
            ...
            expect(fastMcpService.callTool).toHaveBeenCalledWith('assessment_evaluate_test', {
                userId: 'user-001',
                testId: 'test-001',
    ...
    describe('generatePlacementTest', () => {
        it('should call callTool with assessment_placement_test and default count 15', async () => {
            ...
            expect(fastMcpService.callTool).toHaveBeenCalledWith('assessment_placement_test', {
                userId: 'user-001',
                questionCount: 15,
            });
            expect(result).toEqual(mockResult);
    ...
    describe('evaluatePlacementTest', () => {
        ...
        it('should call callTool with assessment_evaluate_placement', async () => {
            ...
            expect(fastMcpService.callTool).toHaveBeenCalledWith('assessment_evaluate_placement', {
                userId: 'user-001',
                testId: 'placement-001',
