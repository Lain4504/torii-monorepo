...
describe('SenseiService', () => {
    ...
    describe('checkGrammar', () => {
        it('should call callTool with sensei_check_grammar', async () => {
            ...
            const result = await service.checkGrammar(mockRequester as any, '私は学生です');

            expect(fastMcpService.callTool).toHaveBeenCalledWith('sensei_check_grammar', {
                userId: 'user-001',
                text: '私は学生です',
            });
    ...
    describe('translate', () => {
        it('should call callTool with sensei_translate', async () => {
            ...
            const result = await service.translate(mockRequester as any, 'こんにちは', 'Japanese', 'English');
    ...
    describe('createFlashcard', () => {
        it('should call callTool with sensei_create_flashcard and default level N4', async () => {
            ...
            const result = await service.createFlashcard(mockRequester as any, 'animals');

            expect(fastMcpService.callTool).toHaveBeenCalledWith('sensei_create_flashcard', {
                userId: 'user-001',
                topic: 'animals',
                level: 'N4',
            });
    ...
    describe('generatePracticeDrill', () => {
        it('should call callTool with sensei_generate_drill and default level/count', async () => {
            ...
            expect(fastMcpService.callTool).toHaveBeenCalledWith('sensei_generate_drill', {
                userId: 'user-001',
                type: 'grammar',
    ...
    describe('simulateConversation', () => {
        it('should call callTool with sensei_simulate_conversation and defaults', async () => {
            ...
            const result = await service.simulateConversation(mockRequester as any, 'restaurant');

            expect(fastMcpService.callTool).toHaveBeenCalledWith('sensei_simulate_conversation', {
                userId: 'user-001',
                scenario: 'restaurant',
                level: 'N4',
                turns: 4,
        ...
        it('should pass custom level and turns', async () => {
            ...
            await service.simulateConversation(mockRequester as any, 'office', 'N2', 6);
    ...
    describe('recommendResources', () => {
        it('should call callTool with sensei_recommend_resources and defaults', async () => {
            ...
            const result = await service.recommendResources(mockRequester as any, 'grammar');

            expect(fastMcpService.callTool).toHaveBeenCalledWith('sensei_recommend_resources', {
                userId: 'user-001',
                topic: 'grammar',
                resourceType: 'all',
                level: undefined,
        ...
        it('should pass specific resourceType and level', async () => {
            ...
            await service.recommendResources(mockRequester as any, 'reading', 'book', 'N3');
    ...
    describe('chat', () => {
        ...
        it('should pass existing chat history', async () => {
            ...
            await service.chat(mockRequester as any, 'Tell me about N3 grammar', history);
