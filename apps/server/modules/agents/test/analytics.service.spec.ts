...
describe('AnalyticsService', () => {
    ...
    describe('trackProgress', () => {
        it('should call callTool with analytics_track_progress and default timeframe "month"', async () => {
            ...
            expect(fastMcpService.callTool).toHaveBeenCalledWith('analytics_track_progress', {
                userId: 'user-001',
                timeframe: 'month',
            });
    ...
    describe('suggestStudyPath', () => {
        it('should call callTool with analytics_suggest_study_path', async () => {
            ...
            expect(fastMcpService.callTool).toHaveBeenCalledWith('analytics_suggest_study_path', {
                userId: 'user-001',
                targetLevel: 'N3',
                timeframe: undefined,
            });
    ...
    describe('generateReport', () => {
        it('should call callTool with analytics_generate_report and default type/timeframe', async () => {
            ...
            expect(fastMcpService.callTool).toHaveBeenCalledWith('analytics_generate_report', {
                userId: 'user-001',
    ...
    describe('getReadinessProfile', () => {
        it('should call callTool with analytics_get_readiness_profile', async () => {
            ...
            const result = await service.getReadinessProfile(mockRequester as any, 'N3');

            expect(fastMcpService.callTool).toHaveBeenCalledWith('analytics_get_readiness_profile', {
                userId: 'user-001',
                targetLevel: 'N3',
            });
            expect(result).toEqual(mockResult);
