...
import { LessonQueryDto, CreateLessonDto, UpdateLessonRequestDto } from '@workspace/dtos';
...
export class LessonController {
  ...
  async create(@Payload() input: CreateLessonDto) {
  ...
  async update(@Payload() data: UpdateLessonRequestDto) {
