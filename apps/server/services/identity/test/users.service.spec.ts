...
describe('UsersService', () => {
    ...
    describe('create', () => {
        it('should create a new user', async () => {
            ...
            usersRepository.create.mockResolvedValue({ ...mockUser, email: dto.email });
        ...
        it('should throw BadRequestException if email exists', async () => {
            ...
            await expect(service.create({ email: 'exists@test.com', displayName: 'Ex' }))
    ...
    describe('update', () => {
        it('should allow user to update themselves', async () => {
            ...
            const result = await service.update(mockRequester as any, mockUser.id, dto);
        ...
        it('should throw ForbiddenException if user tries to update another user without perms', async () => {
            const otherRequester = { ...mockRequester, sub: 'other-id', permissions: [] };
            await expect(service.update(otherRequester as any, mockUser.id, {}))
    ...
    describe('delete', () => {
        ...
        it('should hard delete user if requested', async () => {
            ...
            const result = await service.delete(mockRequester as any, mockUser.id, true);
