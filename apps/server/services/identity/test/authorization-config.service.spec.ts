...
describe('AuthorizationConfigService', () => {
    ...
    beforeEach(async () => {
        ...
        service = module.get<AuthorizationConfigService>(AuthorizationConfigService);
    });
    ...
    describe('loadConfig error handling', () => {
        it('should throw error if config loading fails', async () => {
            ...
            await expect(Test.createTestingModule({
                providers: [AuthorizationConfigService],
            }).compile()).rejects.toThrow('Failed to load authorization configuration');
        });
    });
    ...
    describe('reloadConfig', () => {
        it('should reload configuration', () => {
            ...
            const newConfig = { ...mockConfig, system: { ...mockConfig.system, version: '2.0.0' } };
