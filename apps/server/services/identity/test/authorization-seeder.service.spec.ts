...
describe('AuthorizationSeederService', () => {
  ...
  beforeEach(async () => {
    ...
    service = module.get<AuthorizationSeederService>(
      AuthorizationSeederService,
    );
  ...
  describe('onModuleInit', () => {
    it('should call seedIfNeeded and syncPermissionsFromConfig', async () => {
      const seedSpy = jest
        .spyOn(service, 'seedIfNeeded')
        .mockResolvedValue(undefined as any);
      const syncSpy = jest
        .spyOn(service, 'syncPermissionsFromConfig')
        .mockResolvedValue(undefined as any);
  ...
  describe('syncPermissionsFromConfig', () => {
    ...
    it('should handle errors gracefully', async () => {
      prisma.rolePermission.findUnique.mockRejectedValue(
