...
export class UsersHandler {
    ...
    async createInternal(@Payload() data: { dto: AdminCreateInternalUserDTO; requesterId: string }) {
        return {
            user: await this.usersService.createInternalUser(data.dto, data.requesterId)
        };
    }
