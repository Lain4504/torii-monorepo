...
export interface IAuditLogService {
     ...
     */
    query(filters: AuditLogFiltersDTO): Promise<PaginatedResponseDTO<AuditLogResponseDTO>>;
     ...
     */
    getUserActivity(userId: string, limit?: number): Promise<AuditLogActivityDTO[]>;
