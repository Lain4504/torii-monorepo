...
export class ClassReviewController {
  ...
  async listByClass(
    ...
    const result = await firstValueFrom(
      this.nats.send(
        { cmd: 'academy.classReview.listByClass' },
        { classId, query },
      ),
    );
  ...
  async create(
    ...
    const result = await firstValueFrom(
      this.nats.send(
        { cmd: 'academy.classReview.create' },
        { classId, userId, dto },
      ),
    );
    return successResponse(result);
  ...
  async update(
    ...
    const result = await firstValueFrom(
      this.nats.send(
        { cmd: 'academy.classReview.update' },
        { id, userId, dto },
      ),
    );
    return successResponse(result);
  ...
  async adminList(
    @Query(new ZodValidationPipe(academyClassReviewAdminQueryDTOSchema))
    query: any,
  ) {
    const result = await firstValueFrom(
