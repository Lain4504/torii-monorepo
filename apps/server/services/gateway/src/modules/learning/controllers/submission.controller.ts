...
export class SubmissionController {
  ...
  private sendCmd(cmd: string, payload: any) {
    return firstValueFrom(
      this.natsClient.send({ cmd: `learning.submission.${cmd}` }, payload),
    );
  }
  ...
  my(
    ...
    return this.sendCmd('getMySubmission', {
      assignmentId,
