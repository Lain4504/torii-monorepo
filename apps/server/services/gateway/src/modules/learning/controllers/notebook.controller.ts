...
export class NotebookController {
  ...
  async createNotebook(@Body() input: any, @Req() req: ReqWithRequester) {
    try {
      ...
      throw new HttpException(
        error.message || 'Failed to create notebook',
        error.status || 400,
      );
    }
  }
  ...
  async findAllNotebooks(@Query() query: any, @Req() req: ReqWithRequester) {
    try {
      ...
      throw new HttpException(
        error.message || 'Failed to fetch notebooks',
        error.status || 400,
      );
    }
  }
  ...
  async findPublicNotebooks(@Query() query: any, @Req() req: ReqWithRequester) {
    try {
      ...
      throw new HttpException(
        error.message || 'Failed to fetch public notebooks',
        error.status || 400,
      );
    }
  }
  ...
  async findOneNotebook(@Param('id') id: string, @Req() req: ReqWithRequester) {
    try {
      ...
      throw new HttpException(
        error.message || 'Failed to fetch notebook',
        error.status || 400,
      );
    }
  }
  ...
  async updateNotebook(
    ...
    try {
      ...
      throw new HttpException(
        error.message || 'Failed to update notebook',
        error.status || 400,
      );
    }
  }
  ...
  async deleteNotebook(@Param('id') id: string, @Req() req: ReqWithRequester) {
    try {
      ...
      throw new HttpException(
        error.message || 'Failed to delete notebook',
        error.status || 400,
      );
    }
  }
  ...
  async bulkCreateEntries(
    ...
    try {
      ...
      throw new HttpException(
        error.message || 'Failed to bulk create entries',
        error.status || 400,
      );
    }
  }
