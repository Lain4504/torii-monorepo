...
export class QuestionController {
  ...
  async findAll(@Query() query: any) {
    try {
      const result = await firstValueFrom(
        this.natsClient.send({ cmd: 'learning.question.findAll' }, query),
      );
  ...
  async findById(@Param('id') id: string) {
    try {
      const result = await firstValueFrom(
        this.natsClient.send({ cmd: 'learning.question.findById' }, { id }),
      );
  ...
  async getByCategory(@Param('category') category: string) {
    try {
      ...
      return errorResponse(
        error.message || 'Failed to fetch questions by category',
      );
    }
  }
  ...
  async getByJlptLevel(@Param('jlptLevel') jlptLevel: string) {
    try {
      ...
      return errorResponse(
        error.message || 'Failed to fetch questions by JLPT level',
      );
    }
  }
  ...
  async getByStatus(@Param('status') status: string) {
    try {
      ...
      return errorResponse(
        error.message || 'Failed to fetch questions by status',
      );
    }
  }
  ...
  async getByPool(@Param('poolId') poolId: string) {
    try {
      ...
      return errorResponse(
        error.message || 'Failed to fetch questions by pool',
      );
    }
  }
  ...
  async sendForReview(@Param('id') id: string, @Req() req: ReqWithRequester) {
    try {
      ...
      return errorResponse(
        error.message || 'Failed to send question for review',
      );
    }
  }
}
