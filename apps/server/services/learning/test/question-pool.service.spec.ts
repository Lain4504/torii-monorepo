...
describe('QuestionPoolService', () => {
  ...
  describe('create', () => {
    ...
    it('should throw ForbiddenException if missing permission', async () => {
      ...
      await expect(
        service.create(requester as any, { name: 'P' } as any),
  ...
  describe('delete', () => {
    ...
    it('should throw NotFoundException if pool not found', async () => {
      ...
      await expect(
        service.delete(mockRequester as any, 'pool-1'),
  ...
  describe('update', () => {
    it('should update pool successfully', async () => {
      mockQuestionPoolRepository.findById.mockResolvedValue(mockPool);
      mockQuestionPoolRepository.update.mockResolvedValue({
        ...mockPool,
        name: 'New Name',
      });

      const result = await service.update(mockRequester as any, 'pool-1', {
        name: 'New Name',
      });
