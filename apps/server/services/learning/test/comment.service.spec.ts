...
describe('CommentService', () => {
  ...
  describe('createComment', () => {
    ...
    it('should throw NotFoundException if blog not found', async () => {
      ...
      await expect(service.createComment(createDto)).rejects.toThrow(
        NotFoundException,
      );
    });
  });
  ...
  describe('updateComment', () => {
    ...
    it('should throw BadRequestException if author does not match', async () => {
      commentRepository.findById.mockResolvedValue(mockComment);
      await expect(
        service.updateComment(COMMENT_ID, 'wrong-user', updateDto),
