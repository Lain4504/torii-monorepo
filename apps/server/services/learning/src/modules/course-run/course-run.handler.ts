...
export class CourseRunHandler {
  ...
  async update(
    @Payload() data: CourseRunUpdateDTO & { id: string; requester: Requester },
  ) {
  ...
  async findAllAdmin(
    @Payload() query: CourseRunSearchRequestDTO & { requester: Requester },
  ) {
  ...
  async findMyRuns(
    @Payload() data: CourseRunSearchRequestDTO & { requester: Requester },
  ) {
  ...
  async updateStatus(
    @Payload() data: { id: string; status: any; requester: Requester },
  ) {
