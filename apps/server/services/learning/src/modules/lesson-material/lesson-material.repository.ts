...
export class LessonMaterialRepository implements ILessonMaterialRepository {
   ...
   */
  async create(
    data: Prisma.LessonMaterialCreateInput,
  ...
  async update(
    id: string,
    data: Prisma.LessonMaterialUpdateInput,
  ): Promise<LessonMaterial> {
  ...
  async checkLecturerAccess(
    ...
    return lesson.module.courseMaster.courseRuns.some(
      (run) => run.lecturerId === lecturerId,
    );
  }
