...
import {
  QUESTION_POOL_SERVICE_TOKEN,
  IQuestionPoolService,
} from '@server/learning/interfaces/services/i-question-pool.service';
import {
...
export class QuestionPoolHandler {
  ...
  async findById(@Payload() data: { id: string }) {
    return this.questionPoolService.findById(data.id);
  }
