...
import {
  ...
  IQuestionService,
} from '@server/learning/interfaces/services/i-question.service';
import {
  QuestionCreateDTO,
  QuestionUpdateDTO,
  QuestionQueryDTO,
...
export class QuestionHandler {
  ...
  async createMany(
    @Payload() data: { dtos: QuestionCreateDTO[]; requester: Requester },
  ) {
  ...
  async update(
    @Payload() data: QuestionUpdateDTO & { id: string; requester: Requester },
  ) {
  ...
  async deleteMany(
    @Payload() data: { questionIds: string[]; requester: Requester },
  ) {
