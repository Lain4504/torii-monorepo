  ...
  describe('sendEmail', () => {
    ...
    it('should send order_success email', async () => {
      ...
      expect(pug.renderFile).toHaveBeenCalledWith(
        expect.stringContaining('order-success.pug'),
        event.data,
      );
    ...
    it('should send verification email', async () => {
      ...
      expect(pug.renderFile).toHaveBeenCalledWith(
        expect.stringContaining('verification.pug'),
        event.data,
      );
      expect(sharedEmailService.sendMail).toHaveBeenCalledWith({
        to,
    ...
    it('should send password_reset email', async () => {
      ...
      expect(pug.renderFile).toHaveBeenCalledWith(
        expect.stringContaining('password-reset.pug'),
        event.data,
      );
      expect(sharedEmailService.sendMail).toHaveBeenCalledWith({
        to,
    ...
    it('should send password_reset_confirmation email', async () => {
      ...
      expect(pug.renderFile).toHaveBeenCalledWith(
        expect.stringContaining('password-reset-confirmation.pug'),
        event.data,
      );
      expect(sharedEmailService.sendMail).toHaveBeenCalledWith({
        to,
    ...
    it('should send otp email', async () => {
      ...
      expect(pug.renderFile).toHaveBeenCalledWith(
        expect.stringContaining('otp.pug'),
        event.data,
      );
      expect(sharedEmailService.sendMail).toHaveBeenCalledWith({
        to,
    ...
    it('should send 2fa_code email', async () => {
      ...
      expect(pug.renderFile).toHaveBeenCalledWith(
        expect.stringContaining('2fa-code.pug'),
        event.data,
      );
      expect(sharedEmailService.sendMail).toHaveBeenCalledWith({
        to,
    ...
    it('should send course_enrollment email', async () => {
      ...
      expect(pug.renderFile).toHaveBeenCalledWith(
        expect.stringContaining('enrollment-success.pug'),
        event.data,
      );
      expect(sharedEmailService.sendMail).toHaveBeenCalledWith({
        to,
    ...
    it('should send invite email', async () => {
      ...
      expect(pug.renderFile).toHaveBeenCalledWith(
        expect.stringContaining('invite.pug'),
        event.data,
      );
      expect(sharedEmailService.sendMail).toHaveBeenCalledWith({
        to,
    ...
    it('should send refund_status email (APPROVED)', async () => {
      ...
      expect(pug.renderFile).toHaveBeenCalledWith(
        expect.stringContaining('refund-status.pug'),
        event.data,
      );
      expect(sharedEmailService.sendMail).toHaveBeenCalledWith({
        to,
