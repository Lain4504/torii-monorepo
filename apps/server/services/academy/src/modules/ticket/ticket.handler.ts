...
export class TicketHandler {
  ...
  async updateRefundStatus(
    ...
    const ticketDto: UpdateTicketStatusDTO = {
      status: this.mapRefundStatusToTicketStatus(payload.dto.status) as TicketStatus,
  ...
  private mapRefundStatusToTicketStatus(status?: RefundStatus): TicketStatus | undefined {
