import {
    ...
    CreatePollReq,
    PollInfo,
    PollResponsesResult, PollsStats,
...
export interface IPollsService{
     ...
     * @param userId
     */
    userSelectedOption(roomId: string, pollId: string, userId: string): Promise<string>;
     ...
     * @param pollId
     */
    getPollResponsesDetails(roomId: string, pollId: string): Promise<Record<string, string>>;
     ...
     * @param pollId
     */
    getResponsesResult(roomId: string, pollId: string): Promise<PollResponsesResult>;
