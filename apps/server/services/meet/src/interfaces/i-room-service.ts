...
import {
    ...
    BreakoutRoom, BroadcastBreakoutRoomMsgReq,
    ChangeVisibilityRes,
    ...
    GetActiveRoomInfoReq, IncreaseBreakoutRoomDurationReq,
    IsRoomActiveReq,
    IsRoomActiveRes,
    JoinBreakoutRoomReq,
    NatsKvRoomInfo,
...
export interface IRoomService {
     ...
     * @returns Number of rows affected
     */
    incrementOrDecrementNumParticipants(roomSid: string, operator: '+' | '-'): Promise<number>;
     ...
     */
    compareDurationWithParentRoom(mainRoomId: string, duration: number): Promise<void>;
     ...
     * @returns { status: boolean, msg: string }
     */
    changeVisibility(req: ChangeVisibilityRes): Promise<{ status: boolean; msg: string }>;
