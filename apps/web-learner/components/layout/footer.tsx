                    ...
                    <div className="lg:col-span-2 space-y-8">
                        <Link href="/" className="flex items-center gap-3 group">
                            ...
                            <div className="flex flex-col">
                                <span className="font-sans font-bold text-2xl tracking-tighter text-foreground italic">TORII</span>
                ...
                <div className="relative rounded-[2.5rem] bg-muted/30 border border-border/40 p-8 md:p-12 mb-20 overflow-hidden group">
                    ...
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-12 relative z-10">
                        <div className="max-w-md text-center lg:text-left space-y-4">
                            <h3 className="text-3xl md:text-4xl font-sans font-bold tracking-tight text-foreground italic leading-tight">
