...
export function BlogClient() {
    ...
    return (
        <div className="max-w-[1280px] mx-auto px-6 pt-32 pb-16 space-y-12">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex flex-wrap gap-2">
                            {popularTags.map((tag) => (
                                <span
                                    key={tag}
                                    className="px-3 py-1 bg-muted text-muted-foreground text-xs font-medium rounded-full cursor-pointer hover:bg-primary/20 hover:text-primary transition-colors"
                                >
                                    {tag}
                                </span>
                            ))}
