                    ...
                    <SidebarMenuItem className="px-2 group-data-[collapsible=icon]:px-0">
                        ...
                        >
                            ...
                            <div className="grid flex-1 text-left text-sm leading-tight ml-2 group-data-[collapsible=icon]:hidden">
                                <span className="truncate font-serif font-black italic text-lg tracking-tight">Torii Learning</span>
                                <span className="truncate text-[9px] font-bold uppercase tracking-[0.2em] opacity-50">Student Portal</span>
                            </div>
                        </SidebarMenuButton>
                    </SidebarMenuItem>
                </SidebarMenu>
