...
export default function PrivacyPolicyPage() {
    ...
    return (
        <div className="bg-[#f8f6f6] dark:bg-[#221610] min-h-screen text-slate-900 dark:text-slate-100 antialiased font-sans">
            {/* Top Navigation Bar */}
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex h-16 items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <span className="text-xl font-bold tracking-tight">Edutech Japan</span>
                        </div>
                        <nav className="hidden md:flex items-center gap-8">
                            <Link className="text-sm font-medium hover:text-[#ec5b13] transition-colors" href="#">Trang chủ</Link>
                            <Link className="text-sm font-medium hover:text-[#ec5b13] transition-colors" href="#">Danh sách khóa học</Link>
                            <Link className="text-sm font-medium hover:text-[#ec5b13] transition-colors" href="#">Trợ giúp</Link>
                            <button className="bg-[#ec5b13] hover:bg-[#ec5b13]/90 text-white px-5 py-2 rounded-xl text-sm font-bold transition-all flex items-center gap-2">
                ...
                <div className="flex flex-col lg:flex-row gap-12">
                    ...
                    <aside className="lg:w-72 flex-shrink-0">
                        <div className="sticky top-28 space-y-6">
                            <div className="p-6 bg-white dark:bg-[#221610]/50 border border-slate-200 dark:border-slate-800 rounded-xl shadow-sm">
                                <div className="flex items-center gap-2 mb-4 border-b border-slate-100 dark:border-slate-800 pb-2">
                                    <List className="text-[#ec5b13] size-5" />
                            ...
                            <div className="p-4 bg-[#ec5b13]/5 border border-[#ec5b13]/20 rounded-xl">
                                <p className="text-xs font-semibold text-[#ec5b13] uppercase tracking-wider mb-2">Thông báo cập nhật</p>
                    ...
                    <article className="flex-1 max-w-3xl">
                        ...
                        <div className="mb-12">
                            <nav className="flex items-center gap-2 text-sm text-slate-500 mb-6">
                                <Link className="hover:text-[#ec5b13]" href="#">Trang chủ</Link>
                                <ChevronRight className="size-3" />
                                <span className="text-slate-900 dark:text-slate-100 font-medium">Chính sách bảo mật</span>
                            </nav>
                            <h1 className="text-4xl sm:text-5xl font-black tracking-tight text-slate-900 dark:text-slate-100 mb-4">
                                Chính sách bảo mật
                        ...
                        <div className="space-y-8">
                            ...
                            <section id="collection">
                                <h2 className="text-2xl font-bold border-l-4 border-[#ec5b13] pl-4 mb-6 mt-12 text-slate-900 dark:text-slate-100">
                                ...
                                <div className="p-6 bg-slate-100 dark:bg-slate-800/50 rounded-xl border border-slate-200 dark:border-slate-800">
                                    <div className="flex items-start gap-4">
                                        <div className="bg-[#ec5b13]/10 p-2 rounded-lg">
                                            <HelpCircle className="text-[#ec5b13] size-6" />
                                        </div>
                                        <div>
                        ...
                        <div className="mt-16 pt-8 border-t border-slate-200 dark:border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4">
                            ...
                            <div className="flex gap-4">
                                <button className="text-sm font-medium text-slate-600 dark:text-slate-400 hover:text-[#ec5b13] transition-colors flex items-center gap-1">
            ...
            <footer className="bg-slate-100 dark:bg-slate-900/50 py-12 mt-20 border-t border-slate-200 dark:border-slate-800">
                <div className="max-w-7xl mx-auto px-4 text-center">
                    <div className="flex justify-center items-center gap-2 text-slate-400 mb-6">
                        ...
                        <span className="font-bold tracking-tight">Edutech Japan</span>
                    </div>
                    <div className="flex flex-wrap justify-center gap-x-8 gap-y-2 mb-8">
                        <Link className="text-sm text-slate-600 dark:text-slate-400 hover:text-[#ec5b13] transition-colors" href="#">Về chúng tôi</Link>
                        <Link className="text-sm text-slate-600 dark:text-slate-400 hover:text-[#ec5b13] transition-colors" href="#">Thông tin kinh doanh</Link>
                        <Link className="text-sm text-slate-600 dark:text-slate-400 hover:text-[#ec5b13] transition-colors" href="#">§iều khoản dịch vụ</Link>
                        <Link className="text-sm text-slate-600 dark:text-slate-400 hover:text-[#ec5b13] transition-colors" href="#">Trung tâm hỗ trợ</Link>
                    </div>
                </div>
            </footer>
        </div>
