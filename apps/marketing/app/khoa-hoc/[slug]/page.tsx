...
const VideoIcon = (props: IconWrapperProps) => <HugeiconsIcon icon={Video02Icon} {...props} />
const Certificate = (props: IconWrapperProps) => <HugeiconsIcon icon={Certificate01Icon} {...props} />
const Headphones = (props: IconWrapperProps) => <HugeiconsIcon icon={HeadphonesIcon} {...props} />
