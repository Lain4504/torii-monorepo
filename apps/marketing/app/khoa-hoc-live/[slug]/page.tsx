...
const Certificate = (props: IconWrapperProps) => <HugeiconsIcon icon={Certificate01Icon} {...props} />
const Message = (props: IconWrapperProps) => <HugeiconsIcon icon={Message01Icon} {...props} />
const Fire = (props: IconWrapperProps) => <HugeiconsIcon icon={FireIcon} {...props} />
const VideoCamera = (props: IconWrapperProps) => <HugeiconsIcon icon={VideoCameraAiIcon} {...props} />
const Teacher = (props: IconWrapperProps) => <HugeiconsIcon icon={TeacherIcon} {...props} />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                        ...
                        <div>
                            ...
                            <ul className="space-y-4 text-zinc-400 text-sm">
                                ...
                                <li className="flex items-center gap-2"><div className="size-8 rounded-full bg-zinc-900 flex items-center justify-center"><Message className="size-4" /></div> <span>0123 456 789</span></li>
                            </ul>
                        </div>
                    </div>
