...
const Search = (props: IconWrapperProps) => <HugeiconsIcon icon={Search01Icon} {...props} />
...
const DoubleArrowRight = (props: IconWrapperProps) => <HugeiconsIcon icon={ArrowRightDoubleIcon} {...props} />
const Mail = (props: IconWrapperProps) => <HugeiconsIcon icon={Mail01Icon} {...props} />
            ...
            <header className="sticky top-0 z-50 w-full border-b bg-white/80 backdrop-blur-md">
                <div className="container mx-auto px-4 lg:px-8 h-20 flex items-center justify-between">
                    ...
                    <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-zinc-600">
                        <Link href="/" className="hover:text-[#E63946] transition-colors">Về Torii</Link>
                        ...
                        <Link href="/tin-tuc" className="text-[#E63946] font-bold transition-colors border-b-2 border-[#E63946] py-1">Tin tức</Link>
                    </nav>
