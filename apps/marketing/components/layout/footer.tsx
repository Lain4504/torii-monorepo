            ...
            <div className="container mx-auto px-4 lg:px-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                <div className="space-y-6">
                    <div className="flex items-center gap-2">
                        <HugeiconsIcon icon={Layout01Icon} className={`size-8 text-[#E63946] fill-current`} />
                ...
                <div className="space-y-6 lg:ml-auto">
                    ...
                    <ul className="space-y-3 text-sm">
                        ...
                        <li><Link href="#" className="hover:text-white transition-colors text-zinc-400">Thư viện VOD JLPT</Link></li>
                        <li><Link href="#" className="hover:text-white transition-colors text-zinc-400">Lịch khai giảng Live</Link></li>
