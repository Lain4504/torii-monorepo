...
export const publishFileAttachmentToChat = async (
  ...
  const message = `<a class="attachment-message flex items-center gap-3 break-all" href="${SERVER_URL}/download/uploadedFile/${filePath}" target="_blank" rel="noreferrer">
