...
import InterimTextDisplay from '@/components/translation-transcription/displays/history/interim-text-display';
...
const SubtitleHistoryPanel = ({
  ...
  return (
    <PopoverPanel
      className="SpeechHistory absolute left-5 z-10 bottom-28 w-full max-w-[330px] bg-foreground/85 h-ful rounded-lg border border-muted dark:border-foreground"
      static={showPopover}
    >
