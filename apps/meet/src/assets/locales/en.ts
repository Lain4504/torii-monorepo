export default
{
  ...
  "notifications": {
    ...
    "max-file-size-exceeds": "The file is larger than the maximum allowed size of {{size}}MB.",
    ...
    "waiting-for-approval": "A moderator has been notified and will let you in shortly. Thanks for your patience!",
    "room-disconnected-title": "Disconnected",
    "room-disconnected-default": "You were disconnected due to an unexpected error: {{reason}}. Please try to rejoin.",
    "room-disconnected-client-initiated": "You have disconnected from the meeting.",
    "room-disconnected-duplicate-entry": "Someone else has joined with the same user ID.",
    "room-disconnected-server-shutdown": "The meeting server has shut down.",
    ...
    "room-disconnected-state-mismatch": "A connection error occurred. Please try rejoining.",
    ...
    "your-connection-quality-not-good": "Your connection to the meeting is unstable.",
    "your-connection-quality-lost": "Your connection to the meeting is poor.",
    ...
    "e2ee-empty-key-msg": "The security key cannot be empty.",
    ...
    "invalid-missing-data": "Invalid or missing data received",
    ...
    "whiteboard-other-task-to-finish": "The whiteboard is preparing new content. Please wait.",
    ...
    "new-system-message-in-chat": "A new system message has been posted in the public chat.",
    "queue-holding-messages": "Connection problem: messages are being held. ({{error}})",
    "queue-discarded-message": "A message could not be sent and was discarded. ({{error}})",
    "request-submitted-wait": "Your request has been submitted. Please wait for confirmation"
  },
  "room-metadata": {
  ...
  "app": {
    ...
    "insert-secret-help": "For this secure meeting, everyone must use the same Security Key. If it doesn't match, you won't be able to connect. Please get the correct Security Key from the meeting organizer.",
    "save": "Save"
  },
  "left-panel": {
    ...
    "select-chat-conversation-title": "Select a conversation",
    "menus": {
      "items": {
  ...
  "right-panel": {
    ...
    "sending-message": "Please wait, sending..."
  },
  "footer": {
    "hide-footer": "Hide footer",
    "show-footer": "Show footer",
    "icons": {
      "select-webcam": "Select webcam",
      "start-webcam": "Turn On Camera",
      "turn-off-webcam": "Turn Off Camera",
      ...
      "hide-ai-chat-panel": "Hide AI Assistant",
      "show-ai-chat-panel": "Show AI Assistant",
      ...
      "show-polls-panel": "Show Polls",
      "hide-polls-panel": "Hide Polls",
      "show-translation-settings": "Show Transcription Settings",
      "hide-translation-settings": "Hide Transcription Settings",
      "promote-presenter": "Make Presenter",
      "demote-presenter": "Remove as Presenter",
      "you-are-muted": "No one can hear you. You're muted."
    },
    "menus": {
    ...
    "notice": {
      ...
      "rtmp-url-invalid": "The RTMP URL is not valid or supported.",
      "rtmp-stream-key-required": "A stream key is required.",
  ...
  "whiteboard": {
    ...
    "drag-drop-file": "Drag and drop your file to upload",
    "max-file-size": "Max file size: {{size}} MB",
    "or": "OR",
    "select-file": "Select a File",
    "add-to-whiteboard": "Add to Whiteboard",
  ...
  "breakout-room": {
    ...
    "push": "Push",
    "you-pushed-user": "A join notification has been sent to {{name}}."
  },
  "landing": {
    "connecting-media-server": "Connecting to the meeting...",
    "modal-title": "Microphone and Camera Preferences",
    "ready-to-join": "Ready to join?",
    "join-prompt": "Set up your devices now, or join as a listener. You can always control your microphone and camera later during the meeting.",
    "join-prompt-mic-locked": "The microphone is disabled for this meeting. You can enable your camera or join as a listener.",
    "join-prompt-cam-locked": "The camera is disabled for this meeting. You can enable your microphone or join as a listener.",
    "join-prompt-both-locked": "The microphone and camera are disabled for this meeting. Please join as a listener.",
    "enable-mic-cam-btn": "Enable Microphone and Camera",
    "enable-mic-btn": "Enable Microphone",
    "enable-cam-btn": "Enable Camera",
    "join-as-listener-btn": "Join as a listener",
    "webcam-menu-title": "Select Camera",
    "mic-menu-title": "Select Microphone",
    "background-filter-title": "Background & Filters",
    "config-background-btn": "Configure Camera Background",
    "waiting-for-approval-title": "You're in the waiting room"
  },
  "external-display-link-display": {
    ...
    "iframe-title": "Embedded external content"
  },
  "ingress-features": {
  ...
  "speech-services": {
    ...
    "service-started": "Service has been started.",
    "service-ended": "Service has ended.",
    "start-service": "Start",
    "stop-service": "Stop",
    "update-service": "Update",
    "service-stopped": "The transcription service has been stopped.",
    ...
    "download-header": "Subtitle History for {{name}}\nLanguage: {{lang}}\nGenerated on: {{date}} at {{time}}",
    "mic-not-ready-warning": "To start the service, you must enable your microphone.",
    "max-lang-selection-warning": "You can select a maximum of {{num}} languages for translation",
    "read-and-write-in-label": "Read & Write In (max: {{num}}):",
    "enable-trans-synthesis": "Enable translation synthesis"
  },
  "insights": {
    "setting-modal-title": "Insights AI settings",
    "start-service": "Start service",
    "stop-service": "Stop service",
    "update-service": "Update Settings",
    "service-started-successfully": "Service has been started successfully",
    "service-stopped-successfully": "Service has been stopped successfully",
    "tab-ai-text-chat-title": "AI Assistant Chat",
    "tab-meeting-summarization-title": "Meeting summarization",
    "feature-disable-while-e2ee-self-key-enabled": "This feature is disabled when self-managed End-to-End Encryption is active.",
    "not-enough-credit-to-start-service": "Insufficient credit to start this service. Please contact an administrator to add more credit.",
    "ai-text-chat": {
      "name": "AI Assistant",
      "panel-title": "AI Assistant Chat",
      "enable": "Enable AI Assistant",
      "allow-everyone": "Available to All Participants",
      "allowed-users": "Allowed Participants",
      "users-required": "At least one participant must be selected.",
      "chat-box-placeholder": "Ask the AI Assistant a question...",
      "responding-placeholder": "AI Assistant is responding..."
    },
    "meeting-summarization": {
      "enable": "Enable meeting summarization",
      "summarization-prompt-label": "Summarization Instructions",
      "summarization-prompt-required": "Please enter instructions for how to summarize.",
      "enabled-notification-all": "This meeting's audio is now being recorded to generate a summary."
    }
  }
}
;
