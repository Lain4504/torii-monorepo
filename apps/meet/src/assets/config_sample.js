...
window.walearnconnectConfig = {
  // The URL of your walearnconnect server.
  ...
  /*designCustomization: {
    ...
    custom_css_url: 'https://mydomain.com/walearnconnect_desing.css',
...
window.WAJLC_SERVER_URL = window.walearnconnectConfig.serverUrl;
window.STATIC_ASSETS_PATH = window.walearnconnectConfig.staticAssetsPath;
window.CUSTOM_LOGO = window.walearnconnectConfig.customLogo;
window.ENABLE_DYNACAST = window.walearnconnectConfig.enableDynacast;
window.ENABLE_SIMULCAST = window.walearnconnectConfig.enableSimulcast;
window.VIDEO_CODEC = window.walearnconnectConfig.videoCodec;
window.DEFAULT_WEBCAM_RESOLUTION =
  window.walearnconnectConfig.defaultWebcamResolution;
window.DEFAULT_SCREEN_SHARE_RESOLUTION =
  window.walearnconnectConfig.defaultScreenShareResolution;
window.DEFAULT_AUDIO_PRESET = window.walearnconnectConfig.defaultAudioPreset;
window.STOP_MIC_TRACK_ON_MUTE = window.walearnconnectConfig.stopMicTrackOnMute;
window.FOCUS_ACTIVE_SPEAKER_WEBCAM =
  window.walearnconnectConfig.focusActiveSpeakerWebcam;
window.DESIGN_CUSTOMIZATION = window.walearnconnectConfig.designCustomization;
window.WHITEBOARD_PRELOADED_LIBRARY_ITEMS =
  window.walearnconnectConfig.whiteboardPreloadedLibraryItems;
window.WAJLC_VIRTUAL_BG_IMGS = window.walearnconnectConfig.virtualBackgroundImages;
