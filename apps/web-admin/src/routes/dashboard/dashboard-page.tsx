    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-7 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-100">
        ...
        <Card className="col-span-4 rounded-xl bg-background border border-border/50 shadow-sm overflow-hidden group">
          <CardHeader className="p-6 pb-4">
            <div className="flex items-center justify-between mb-2">
              <div className="inline-flex items-center gap-2 px-2.5 py-1 bg-primary/5 text-primary rounded-full text-[10px] font-bold tracking-wide uppercase">
                <TrendingUp className="size-3" />
                Thống kê Tăng trưởng
              </div>
            </div>
            <CardTitle className="text-xl font-bold tracking-tight text-foreground uppercase">Tổng quan <span className="text-primary">Hiệu suất</span></CardTitle>
        ...
        <Card className="col-span-3 rounded-xl bg-background border border-border/50 shadow-sm">
          <CardHeader className="p-6 pb-4">
            <div className="inline-flex items-center gap-2 px-2.5 py-1 bg-amber-500/10 text-amber-600 rounded-full text-[10px] font-bold tracking-wide uppercase mb-3">
              <DollarSign className="size-3" />
              Hoạt động Gần đây
            </div>
            <CardTitle className="text-xl font-bold tracking-tight text-foreground uppercase">Giao dịch <span className="text-amber-500">Mới nhất</span></CardTitle>
          ...
          <CardContent className="px-6 pb-6">
            ...
            <Button variant="ghost" className="w-full mt-6 h-10 rounded-lg border border-border/30 text-[10px] font-bold uppercase tracking-wide hover:bg-primary/5 hover:text-primary transition-all group">
      ...
      <div className="grid gap-6 md:grid-cols-2 animate-in fade-in slide-in-from-bottom-8 duration-1000">
        <Card className="rounded-xl bg-background border border-border/50 shadow-sm">
          <CardHeader className="p-6 pb-4">
            ...
            <CardTitle className="text-xl font-bold tracking-tight text-foreground uppercase">Yêu cầu <span className="text-primary">Hành động</span></CardTitle>
        ...
        <Card className="rounded-xl bg-background border border-border/50 shadow-sm">
          <CardHeader className="p-6 pb-4">
            ...
            <CardTitle className="text-xl font-bold tracking-tight text-foreground uppercase">Hoạt động <span className="text-amber-500">Khóa học</span></CardTitle>
          ...
          <CardContent className="px-6 pb-6">
            ...
            <Button className="w-full mt-6 h-10 rounded-lg bg-foreground text-background font-bold uppercase tracking-wide text-[10px] shadow-sm hover:translate-y-[-1px] transition-all group">
              Duyệt Khóa học
              <ChevronRight className="ml-2 size-3.5 group-hover:translate-x-1 transition-transform" />
            </Button>
          </CardContent>
    ...
    <div className="space-y-6">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-10 text-center lg:text-left">
          <div className="space-y-5 flex-1 max-w-2xl">
            <div className="flex items-center justify-center lg:justify-start gap-3">
              <div className="inline-flex items-center gap-2 px-2.5 py-1 bg-primary/10 text-primary rounded-full text-[10px] font-bold tracking-wide animate-pulse uppercase">
                <Video className="h-3 w-3" />
                Phiên Trực tiếp
              </div>
            </div>
            <h2 className="text-4xl font-bold tracking-tight text-foreground leading-tight uppercase">Masterclass <br /><span className="text-primary/60">Hội thoại N4</span></h2>
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-6 pt-2">
              <div className="space-y-0.5">
                <p className="text-[9px] font-bold uppercase tracking-widest text-muted-foreground/40">Lịch trình</p>
              ...
              <div className="space-y-0.5">
                <p className="text-[9px] font-bold uppercase tracking-widest text-muted-foreground/40">Tham dự</p>
          ...
          <div className="relative">
            ...
            <Button size="lg" className="relative h-12 px-8 rounded-xl bg-primary text-primary-foreground font-bold uppercase tracking-wide text-[10px] shadow-lg hover:scale-[1.02] active:scale-95 transition-all duration-300 group">
              Tham gia Ngay
      ...
      <div className="grid gap-6 md:grid-cols-2 animate-in fade-in slide-in-from-bottom-8 duration-1000">
        <Card className="rounded-xl bg-background border border-border/50 shadow-sm p-1">
          <CardHeader className="p-6 pb-4">
            <div className="flex items-center justify-between mb-2">
              <CardTitle className="text-xl font-bold tracking-tight text-foreground uppercase">Lịch trình <span className="text-primary">Giảng dạy</span></CardTitle>
        ...
        <Card className="rounded-xl bg-background border border-border/50 shadow-sm p-1">
          <CardHeader className="p-6 pb-4">
            <div className="flex items-center justify-between mb-2">
              <CardTitle className="text-xl font-bold tracking-tight text-foreground uppercase">Hàng đợi <span className="text-amber-500">Bài tập</span></CardTitle>
    ...
    <div className="space-y-8 pb-32">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 relative px-1">
        <div className="space-y-4 max-w-3xl">
          <div className="inline-flex items-center gap-2 px-2.5 py-1 bg-primary/5 text-primary rounded-full text-[10px] font-bold tracking-wide uppercase mb-1 animate-in fade-in slide-in-from-left-4 duration-500">
            <Sparkles className="size-3" />
            Bảng điều khiển Tổng quan
          </div>
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-foreground leading-[0.9] uppercase animate-in fade-in slide-in-from-bottom-4 duration-700">
            {getGreeting()}, <br />
            <span className="text-primary">{user?.displayName?.split(' ')[0] || 'Quản trị viên'}</span>.
          </h2>
          <p className="text-[10px] font-bold uppercase tracking-[0.3em] text-muted-foreground/40 border-l-2 border-primary/20 pl-4 mt-4 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-100">
        ...
        <div className="flex items-center gap-3 pt-6 md:pt-0 animate-in fade-in zoom-in-95 duration-1000 delay-200">
          <Button variant="outline" className="h-11 px-6 rounded-xl bg-background border-border/40 text-muted-foreground hover:text-foreground font-bold uppercase tracking-wide text-[10px] hover:bg-muted/30 transition-all group">
            Thống kê
            <TrendingUp className="ml-2 size-3.5 opacity-40 group-hover:opacity-100 transition-all" />
          </Button>
          <Button className="h-11 px-6 rounded-xl bg-primary text-white font-bold uppercase tracking-wide text-[10px] shadow-lg shadow-primary/20 hover:shadow-primary/30 hover:-translate-y-0.5 transition-all group">
            Xuất Dữ liệu
            <ArrowUpRight className="ml-2 size-3.5 group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform" />
          </Button>
        </div>
