...
import { Bell, Search, Check, Trash2, Sparkles, Clock, Info, CheckCircle2, AlertTriangle, XCircle, MoreVertical, ShieldAlert } from 'lucide-react'
...
const mockNotifications: Notification[] = [
  ...
  },
  {
    ...
    message: '3 users successfully bypassed security filters and were added to the learner database.',
    time: '1 giờ trước',
    date: '12/01/2026',
    read: false,
    type: 'info',
  ...
  },
  {
    ...
    message: 'System core will undergo optimization protocols at 02:00 UTC. Expect 15min downtime.',
    time: '3 giờ trước',
    date: '12/01/2026',
    read: true,
    type: 'warning',
  ...
  },
  {
    ...
    message: 'Premium tier enrollment fee of 500,000 VND confirmed for User NODE-X72.',
    time: '1 ngày trước',
    date: '11/01/2026',
    read: true,
    type: 'success',
  ...
  },
  {
    ...
    message: 'Multiple invalid login attempts detected from IP 192.168.1.1. Firewall has engaged.',
    time: '2 ngày trước',
    date: '10/01/2026',
    read: true,
    type: 'error',
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 px-4">
        <div className="space-y-4">
          ...
          <h1 className="text-4xl md:text-6xl font-serif font-bold tracking-tight text-foreground italic leading-[0.85]">
            Pulse <br />
            <span className="text-primary not-italic text-3xl md:text-5xl">Transmission Log</span>
          </h1>
          <p className="text-[11px] font-bold text-muted-foreground/40 uppercase tracking-[0.15em] italic border-l-2 border-primary/20 pl-6">
            Quản lý tất cả các cập nhật, nhắc nhở và thông tin quan trọng từ <span className="text-foreground">Torii Infrastructure</span>.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 px-4">
        <Card className="md:col-span-3 rounded-[2.5rem] bg-background/40 backdrop-blur-3xl border border-border/20 p-2 flex items-center">
          <div className="relative flex-1">
            ...
            <Input
              placeholder="Tìm kiếm log hệ thống..."
            ...
            {filteredNotifications.length > 0 ? (
                    ...
                    <div className="flex-1 space-y-2">
                      <div className="flex items-start justify-between">
                        <div className="space-y-1">
                          ...
                          <div className="flex items-center gap-3">
                            <span className="inline-flex items-center px-2.5 py-0.5 rounded-full bg-muted/30 text-[8px] font-black uppercase tracking-widest text-primary border border-primary/20">
                              [{notification.node}]
                            </span>
              ...
              <div className="py-32 text-center space-y-6">
                <div className="w-24 h-24 rounded-[3rem] bg-muted/20 mx-auto flex items-center justify-center border border-border/10 relative">
                  ...
                  <ShieldAlert className="w-10 h-10 text-muted-foreground/20 relative z-10" />
                </div>
                <div className="space-y-1">
                  <h3 className="text-xl font-serif font-bold italic text-foreground/40 text-center">Signal Void</h3>
                  <p className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground/20 italic">No system pulses matched your current search payload.</p>
                </div>
              </div>
            )}
          </div>
