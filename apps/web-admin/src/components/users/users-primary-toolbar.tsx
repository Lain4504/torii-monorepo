    ...
    return (
        <div className="flex flex-col lg:flex-row gap-6 items-stretch lg:items-center justify-between w-full">
            ...
            <div className="flex items-center gap-4">
                {/* Role Filter - Zen Select */}
                <div className="hidden sm:block">
                    <Select
                        value={filters.role || 'all'}
                        onValueChange={(value) => onFilterChange({ ...filters, role: value === 'all' ? undefined : value })}
                    >
                        <SelectTrigger className="h-14 w-[200px] rounded-2xl border-border/20 bg-background/50 hover:bg-background/80 transition-all text-[10px] font-black uppercase tracking-widest focus:ring-primary/20">
                ...
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        <Button variant="ghost" className="h-14 rounded-2xl border border-border/20 bg-background/50 hover:bg-background/80 px-6 gap-3 text-[10px] font-black uppercase tracking-widest transition-all group">
