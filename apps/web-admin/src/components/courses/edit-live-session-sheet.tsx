        ...
        <Sheet open={open} onOpenChange={onOpenChange}>
            <SheetContent className="w-full sm:max-w-[600px] flex flex-col p-0">
                ...
                <ScrollArea className="flex-1">
                    <form id="edit-session-form" onSubmit={handleSubmit(onSubmit)} className="space-y-6 p-6">
                        <FieldGroup>
                            <Controller
                                name="title"
                                control={control}
                ...
                <SheetFooter className="p-6 border-t bg-muted/5">
                    ...
                    <Button type="submit" form="edit-session-form" disabled={updateMutation.isPending} className="flex-1">
