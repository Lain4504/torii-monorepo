        ...
        <Sheet open={open} onOpenChange={onOpenChange}>
            <SheetContent className="w-full sm:max-w-[800px] flex flex-col gap-0 p-0 sm:max-h-screen">
                <SheetHeader className="p-6 pb-2">
                    ...
                    <SheetDescription>
                        Cập nhật thông tin chi tiết khóa học. Các thay đổi sẽ được áp dụng ngay lập tức.
                    </SheetDescription>
                </SheetHeader>

                <ScrollArea className="flex-1">
                    <form onSubmit={handleSubmit(onSubmitForm)} className="space-y-6 px-6 pb-6 pt-4" noValidate>
                        {/* Key Metrics */}
                                        ...
                                        <div className="flex items-center gap-3">
                                            <div className="relative flex-1">
                                                <Input
                                                    ...
                                                    className="mt-1 file:mr-4 file:py-1 file:px-3 file:rounded-lg file:border-0 file:text-[10px] file:font-bold file:uppercase file:bg-primary/10 file:text-primary hover:file:bg-primary/20 transition-all cursor-pointer text-muted-foreground"
                                                />
                                                <Film className="absolute right-4 top-1/2 -translate-y/2 h-4 w-4 text-muted-foreground/40 pointer-events-none" />
                                            </div>
                                            {videoFile && (
                                                <Button
                                                    type="button"
                ...
                <div className="p-6 pt-2 w-full border-t">
                    <SheetFooter>
                        ...
                        <Button
                            ...
                            disabled={updateCourse.isPending || (!isDirty && !thumbnailFile && !videoFile)}>
