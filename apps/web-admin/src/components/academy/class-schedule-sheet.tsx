  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="!w-full sm:!max-w-[800px] flex flex-col h-full p-0 text-foreground">
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="flex-1 flex flex-col min-h-0 bg-muted/5">
                    ...
                    <CardContent className="p-4 pt-4 text-foreground">
                        <FieldGroup>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
                                <Field>
                                    <FieldLabel>Địa điểm / Phòng học</FieldLabel>
                                    <div className="relative">
                                ...
                                <Field>
                                    <FieldLabel>Ghi chú cho buổi này</FieldLabel>
                                    <div className="relative">
                                        <FileEdit className="absolute left-3 top-1/2 -translate-y-1/2 size-4 text-muted-foreground" />
                                        <Input 
                                            className="pl-9 bg-background" 
                                            placeholder="Ví dụ: Link zoom, tài liệu..."
          ...
          <SheetFooter className="p-6 border-t bg-muted/10 shrink-0">
