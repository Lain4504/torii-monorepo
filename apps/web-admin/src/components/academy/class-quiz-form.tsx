...
export function ClassQuizForm({
    ...
    return (
        ...
        >
            <Card>
                <CardHeader>
                    <CardTitle>Liên kết Quiz Template</CardTitle>
                    <CardDescription>Chọn một mẫu quiz từ ngân hàng đề của khóa học.</CardDescription>
                </CardHeader>
                <CardContent>
                    <FieldGroup>
                        {!isEdit ? (
            ...
            <Card>
                <CardHeader>
                    <CardTitle>Cấu hình Quiz</CardTitle>
