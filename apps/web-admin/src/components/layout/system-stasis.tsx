    ...
    return (
        <div className={cn("flex flex-col items-center justify-center min-h-[60vh] gap-8 animate-in fade-in duration-700", className)}>
            <div className="relative group">
                ...
                <div className="w-24 h-24 rounded-[2.5rem] bg-card/50 backdrop-blur-3xl border border-primary/20 flex items-center justify-center relative z-10 shadow-xl group-hover:scale-105 transition-transform duration-700">
            ...
            <div className="text-center space-y-4 relative px-4">
                ...
                <div className="space-y-2">
                    <h2 className="text-3xl sm:text-4xl font-sans font-black tracking-tight text-foreground uppercase leading-[0.9]">
